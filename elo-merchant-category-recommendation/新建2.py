...
def train_test(num_rows=None):
    ...
    # load csv
    train_df = read_csv('F:\\zxd\\elo-merchant-category-recommendation\\train.csv')
    test_df = read_csv('F:\\zxd\\elo-merchant-category-recommendation\\test.csv') 
...
def historical_transactions(num_rows=None):
    ...
    # starting to process
    # load csv
    df = pd.read_csv('F:\\zxd\\elo-merchant-category-recommendation\\historical_transactions.csv', nrows=num_rows)
...
def new_merchant_transactions(num_rows=None):
    ...
    # load csv
    df = pd.read_csv('F:\\zxd\\elo-merchant-category-recommendation\\new_merchant_transactions.csv', nrows=num_rows)
